    ...
    switch (pilih)
    {
        ...
        case 6:
            ...
            // ... Class menu statistik penggunaan buku
             ...
             // Membuat objek StatistikPenggunaanBuku
            StatistikPenggunaanBuku statistikPenggunaanBuku = new StatistikPenggunaanBuku();

            // Membuat objek BorrowingData dengan data peminjaman yang ada
            StatistikPenggunaanBuku.BorrowingData borrowingData = new StatistikPenggunaanBuku.BorrowingData();
            borrowingData.Books = dataPeminjaman; // asumsikan dataPeminjaman adalah list buku yang sudah ada

             // Memanggil fungsi PrintStatistics untuk menampilkan statistik
             statistikPenggunaanBuku.PrintStatistics(borrowingData);
...
int BacaInputMenu(string message)
{
    int input;
    while (true)
    {
